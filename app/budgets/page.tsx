      ...
      <div>
        ...
        {spending.length === 0 ? (
          <div className="card animate-in" style={{ textAlign: 'center', padding: '40px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
            ...
            <h3 style={{ margin: 0, color: 'var(--text)', fontFamily: 'var(--font-display)' }}>Nenhum orçamento definido</h3>
            <p style={{ margin: 0, color: 'var(--text-muted)', fontSize: 14 }}>Organize suas finanças criando limites mensais.</p>
            <button onClick={() => setShowForm(true)} style={{ marginTop: 8, padding: '10px 20px', backgroundColor: 'var(--green)', color: 'white', border: 'none', borderRadius: 'var(--radius-sm)', cursor: 'pointer', fontWeight: 600, fontSize: 14, boxShadow: '0 4px 12px rgba(0,200,150,0.3)' }}>
